...
\chapter[Spezialisierungen Waffenloser Kampf]{\color{black}
...
\end{itemize}
\section[Bornländisch]{\color{black} Bornländisch}
{\sffamily\color{black}
...
\section[Gladiatorenstil]{\color{black} Gladiatorenstil}
{\sffamily\color{black}
...
\section[Hammerfaust]{\color{black} Hammerfaust}
{\sffamily\color{black}
...
\section[Hruruzat]{\color{black} Hruruzat}
{\sffamily\color{black}
\item[Spezialisierung}: Raufen +1/+1}
...
\section[Mercenario]{\color{black} Mercenario}
{\sffamily\color{black}
\item[Spezialisierung}: Raufen +1/+1}
...
\section[Unauer Schule]{\color{black} Unauer Schule}
{\sffamily\color{black}
\item[Spezialisierung}: Ringen +1/+1}
